...
import { CustContact, Evaluations, Refer, Rewards, Timeline } from "../pages"; // Assuming the index.js file is directly in the 'pages' folder
  ...
  return (
    ...
    >
      <div className="w-full flex justify-between items-center max-w-7xl mx-auto">
        ...
        {/* becomes a menu when it shrinks */}
